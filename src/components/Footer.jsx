      ...
      <div className='pt-7 bg-violet-500 p-5'>
        <div className="grid grid-cols-4 p-5 text-white font-bold ">
          <div className='text-xl '>
            <Link to={'/'}>
              <i className="fa-solid fa-truck  "></i> <span>Shoppy Cart</span>
            </Link>
       ...
       <div className='text-xl '>
        ...
        <p className='text-white text-sm font-bold text-center'>Copyright ©Allen Sunil Mathew, Shoppy Cart. Built with React Redux.</p>
      </div>
    </>
